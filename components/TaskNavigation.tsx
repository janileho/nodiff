    ...
    <div className="flex items-center justify-center h-full">
      <div className="flex items-center space-x-2">
        <button
          ...
          className="inline-flex items-center px-3 py-1.5 text-xs font-medium text-gray-700 bg-white/60 backdrop-blur-sm rounded-lg hover:bg-white/80 disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-200 border border-white/40"
        >

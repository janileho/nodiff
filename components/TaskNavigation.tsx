    ...
    <div className="px-2 py-0">
      <div className="flex items-center justify-between">
        {currentIndex >= 0 && allTasks.length > 0 ? (
          <div className="text-[10px] leading-none text-gray-600">Tehtävä {currentIndex + 1} / {allTasks.length}</div>
        ) : <div className="h-3" />}
        ...
        <div className="flex items-center space-x-1">
          <button
            ...
            className="inline-flex items-center px-2 py-0 text-[10px] font-medium text-gray-700 bg-white/40 backdrop-blur-sm rounded hover:bg-white/60 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
      ...
      {isNavigating && (
        <div className="mt-0 flex items-center justify-center text-[10px] text-gray-600">
